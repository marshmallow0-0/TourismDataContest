...
import { Banners, NOTUPLOAD } from "../data";
            ...
            <div className="mt-10">
                ...
                < div id="email-newsletter" className="my-30 flex justify-around p-20 font-Pretendard" >
                    ...
                    <div className="mr-20">
                        ...
                        <button className="middle none center rounded-lg bg-indigo-700 py-3 px-6 font-sans text-xs font-bold text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
...
//             !checkedValues[0] && checkedValues[1] ? "url('./img/seoul2.jpeg')" :
//                 checkedValues[0] && checkedValues[1] ? "url('./img/korea.png')" :
//                     "url('./img/selectRegion.png')",
//         backgroundSize: checkedValues[0] && !checkedValues[1] ? '100% 100%' :
//             !checkedValues[0] && checkedValues[1] ? '130% 120%' :
//                 checkedValues[0] && checkedValues[1] ? '50% 50%' :
//                     '70% 70%',
//         backgroundPosition: checkedValues[0] && !checkedValues[1] ? 'top calc(100% - 6em) right calc(100% - 2em)' :
//             !checkedValues[0] && checkedValues[1] ? 'top calc(100% - 2em) right calc(100% - 2em)' :
//                 checkedValues[0] && checkedValues[1] ? 'top calc(100% - 7.5em) right calc(100% - 6em)' :
//                     'top calc(100% - 5em) right calc(100% - 6em)',
//         backgroundRepeat: 'no-repeat',
//     };
